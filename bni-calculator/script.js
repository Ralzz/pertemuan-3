...
function calculateBMI(){
    ...
    if (gender === 'female'){
        ...
        if(bmi < 18.5) {
            result.innerHTML = `BMI KAMU ${bmi}, berat bada kamu kurang!`
        } else if (bmi > 18.5 && bmi <= 24.9){
            result.innerHTML = `BMI KAMU ${bmi}, berat bada kamu ideal :D`
  
        }else {
            result.innerHTML = ` BMI KAMU ${bmi}, berat bada kamu berlebih`
        }
    }
}
